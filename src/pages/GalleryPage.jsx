      ...
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            SUDO modern su satma makinelerimizin fotoğraflarını ve kurulum örneklerini keşfedin.
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg">
            ...
            <div className="mt-8 p-4 bg-blue-50 rounded-lg">
              <p className="text-gray-700">
                <strong>SUDO C Vitaminli Su:</strong> Her zaman taze, C Vitaminli, mineralli, sağlıklı su bazlı içecek. 
                Su otomatlarımız çevre dostu ve 7/24 hizmet vermektedir.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-500 to-blue-700 rounded-2xl p-8 md:p-12 shadow-xl text-white text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            İşletmeniz için en uygun SUDO su satma makinesi modellerini seçmek ve özel fiyat teklifleri almak için bizimle iletişime geçin.
          </p>
