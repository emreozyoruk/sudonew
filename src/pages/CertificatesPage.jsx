        ...
        <div className="container-custom">
          <div className="bg-white rounded-xl p-8 shadow-lg mb-12">
            ...
            <p className="text-lg text-gray-600 mb-8">
              EMC ELEKTRİK & OTOMASYON olarak, ürettiğimiz su satma makinelerinin en yüksek kalite ve güvenlik standartlarına 
            ...
            <div className="mt-8 p-6 bg-blue-50 rounded-lg">
              ...
              <p className="text-gray-700">
                Yukarıda gösterilen sertifikalar, EMC ELEKTRİK & OTOMASYON'un üretim tesislerinin ve su satma makinelerinin 
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Su kalitemiz, düzenli olarak bağımsız laboratuvarlar tarafından test edilmektedir.
                </p>
              </div>
              <div className="text-center">
                <div className="w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
